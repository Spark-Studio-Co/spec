...
export const Selector = ({ label, className, options, storeKey }: ISelectorProps) => {
    ...
    return (
        <div className="flex flex-col relative">
            <div 
                className={`${className} w-full h-[48px] border border-[#737373] rounded-[8px] flex items-center justify-between pl-2 pr-3 ${!isVisible && 'mb-8'} ${isVisible ? 'border-b-0 rounded-b-none' : ''}`}
            >
